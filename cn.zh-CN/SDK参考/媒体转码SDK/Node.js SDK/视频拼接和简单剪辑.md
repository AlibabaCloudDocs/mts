...
2.  设置转码参数。
    ...
    -   MergeList
        ...
        var dot='.';
        var httpStr='http://';
        var mergeVideoURL=httpStr.concat(ossBucket, dot, ossLocation, dot ,'aliyuncs.com/',
                                                 encodeURIComponent(ossInputObject)
                                                );
        var mergeVideo.MergeURL=mergeVideoURL;
        var mergeTail = {};
        var mergeTailURL = httpStr.concat(ossBucket, dot, ossLocation, dot, 'aliyuncs.com/',
