...
```
    ...
    -   [预置静态模板](../../../../cn.zh-CN/API参考/附录/预置模版详情.md#) ID：S00000001-100020表示音频输出为m3u8\(ts\)，预置模板内设置的音频码率为80kbps。
...
```
    ...
    -   [MasterPlayList](../../../../cn.zh-CN/API参考/附录/ 参数详情.md#)定义Master Playlist。

    -   [MultiBitrateVideoStreams](../../../../cn.zh-CN/API参考/附录/ 参数详情.md#)多码率视频流数组。

    -   RefActivityName指定提取视频流的活动名称。

    -   [ExtXStreamInfo](../../../../cn.zh-CN/API参考/附录/ 参数详情.md#)定义多码率视频流的属性，Audio指定音频分组，Subtitles指定字幕分组
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11378/154106419510114_zh-CN.png)
