...
调用QueryTemplateList通过自定义模版ID查询转码模板详情。
...
|TemplateIds|String|是|88c6ca184c0e4\*\*\*\*\*5b665e2a126799|模板ID列表。
...
-   单位：Kbps
-   默认值：128 |
|Id|String|88c6ca184c0e4\*\*\*\*\*5b665e2a126799|转码模板ID。 |
|Container|Object| |容器。 |
|Format|String|flv|容器格式。

 可选范围flv、mp4、ts、m3u8、gif、mp3、ogg、flac。 |
|RequestId|String|3E767BAD-9F4C-4F\*\*\*\*\*AE-E3F4A639066B|请求ID。 |
...
&ResourceOwnerId=1
&TemplateIds=88c6ca184c0e4*****5b665e2a126799
&OwnerAccount=1
&公共请求参数
```
