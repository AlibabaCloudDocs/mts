...
您可以通过媒体处理控制台或使用OSS相关上传工具上传视频文件。同时，我们也提供覆盖所有平台的上传SDK，详情请参见[上传SDK使用说明](../../../../../cn.zh-CN/SDK参考/上传SDK/使用说明.md#)和[上传SDK下载](../../../../../cn.zh-CN/SDK参考/上传SDK/上传SDK下载.md#)。
...
-   媒体处理控制台上传
    ...
    3.  选择**媒体管理** \> **上传视频**，单击 **添加视频**。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11361/155532118210021_zh-CN.png)

    4.  在添加视频对话框中，选择工作流，并单击**添加视频**。

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11361/155532118210022_zh-CN.png)
...
3.  选择所需的 **执行实例**，单击右侧的 **查看实例**。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11361/155532118210025_zh-CN.png)
