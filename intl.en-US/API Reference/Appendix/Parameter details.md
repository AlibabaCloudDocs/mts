...
|Amix|String|No|Audio mixing. Scenarios: for example, to add background music; and to mix two audio tracks of a video.
...
``` |
|URI|String|Yes|Required, resource path. Example: a/b/c/d/video-1.mpd, format: ^\[a-z\]\{1\}\[a-z0-9. /-\]+$ |
