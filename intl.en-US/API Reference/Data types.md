...
|Name|Type|Description|
|:---|:---|:----------|
|InputFile|[InputFile](reseller.en-US/API Reference/Data types.md#)|Input file of the media workflow.|
|UserData|String|Custom data.|
...
|Input|[MediaWorkflowExecutionInput](reseller.en-US/API Reference/Data types.md#)|Input of the media workflow.|
|MediaWorkflowId|String|Media workflow ID.|
|Name|String|Media workflow name.|
|MediaId|String|Media ID.All information generated by the media workflow belongs to this media ID.

|
|ActivityList|[Activity](reseller.en-US/API Reference/Data types.md#)|List of media workflow activities.|
...
|Name|Type|Description|
|:---|:---|:----------|
|Format|[FormatInfo](reseller.en-US/API Reference/Data types.md#)|Format information.|
|Streams|[StreamsInfo](reseller.en-US/API Reference/Data types.md#)|Streaming information.|
...
|Name|Type|Description|
|:---|:---|:----------|
|VideoStreamList|[VideoStream](reseller.en-US/API Reference/Data types.md#)\[\]|Video stream list,containing up to four video streams.

|
|AudioStreamList|[AudioStream](reseller.en-US/API Reference/Data types.md#)\[\]|Audio stream list,containing up to four audio streams.

|
|SubtitleStreamList|[SubtitleStream](reseller.en-US/API Reference/Data types.md#)\[\]|Subtitle stream list,containing up to four subtitle streams.
...
|NetworkCost|[NetworkCost](reseller.en-US/API Reference/Data types.md#)|Network bandwidth consumption.|
...
|File|[File](reseller.en-US/API Reference/Data types.md#)|Original file.|
|Title|String|Title.|
...
|PlayList|[Play](reseller.en-US/API Reference/Data types.md#)\[\]|Playlist.|
|SnapshotList|[Snapshot](reseller.en-US/API Reference/Data types.md#)\[\]|Screenshot list|
|MediaInfo|[MediaInfo](reseller.en-US/API Reference/Data types.md#)|Media information.|
...
|Width|String|Width.|
|Height|String|Height.|
|File|[File](reseller.en-US/API Reference/Data types.md#)|Playback file.|
...
|File|[File](reseller.en-US/API Reference/Data types.md#)|Screenshot files.|
