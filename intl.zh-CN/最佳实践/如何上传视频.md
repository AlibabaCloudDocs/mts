# 如何上传视频 {#concept_hs4_4wk_x2b .concept}
...
考虑移动端AK安全性问题，选用STS的方式上传文件。关于STS如何增加上传的安全性，参见 [RAM和STS使用指南](../../../../../intl.zh-CN/开发指南/隐藏/权限管理/权限管理概述.md#)。
...
2.  在OSS概览页中找到基础配置区域，单击 **安全令牌**，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/155288168710124_zh-CN.png)

3.  进入到 **安全令牌快捷配置** 页面。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/155288168710125_zh-CN.png)

4.  系进行自动授权，请务必保存下图中三个红框内的参数。单击 **保存AK信息** 后，对话框会关闭，STS的开通完成。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/155288168710126_zh-CN.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/155288168710127_zh-CN.png)
