...
2.  在OSS概览页中找到基础配置区域，单击 **安全令牌**，如下图所示：
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/153717319810124_zh-CN.png)

3.  进入到 **安全令牌快捷配置** 页面。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/153717319810125_zh-CN.png)

4.  系进行自动授权，请务必保存下图中三个红框内的参数。单击 **保存AK信息** 后，对话框会关闭，STS的开通完成。

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/153717319810126_zh-CN.png)

    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/11376/153717319810127_zh-CN.png)
