...
示例调用API，创建HLS标准加密工作流。创建HLS标准加密工作流到播放加密视频的完整步骤，参见 [HLS的加密与播放](https://help.aliyun.com/document_detail/68565.html)。MPS SDK，详情参见 [安装](https://help.aliyun.com/document_detail/55746.html)。
