# 查询转码作业 {#reference_yjq_kft_x2b .reference}
...
|名称|类型|是否必须|描述|
|:-|:-|:---|:-|
|Action|String|是|操作接口名，系统规定参数，取值： QueryJobList|
|JobIds|String|是|转码作业ID列表，逗号分隔，一次最多10个|
...
|NonExistJobIds|String\[ \]|不存在的转码作业ID列表，无数据时该结构不返回|
